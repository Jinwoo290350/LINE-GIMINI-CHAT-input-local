...
ตรวจจับ Intent และวิเคราะห์เนื้อหาในไฟล์ + ตรวจสอบความเกี่ยวข้องอย่างแม่นยำ (ปรับปรุงแล้ว)
"""
import re
...
class ContentAnalyzer:
    """
    วิเคราะห์เนื้อหาในไฟล์เพื่อตรวจจับ Intent (ปรับปรุงแล้ว)
    """
    ...
    def _is_general_conversation(self, message: str) -> bool:
        ...
        general_patterns = [
            ...
            # เพิ่ม pattern ทั่วไป - ปรับปรุงแล้ว
            r'^(ต่อไป)$',  # เฉพาะคำว่า "ต่อไป" เดี่ยวๆ
            r'^(ต่อไป)\s+(อะไร|ไง|ดี)',  # "ต่อไปอะไร", "ต่อไปไง"
            r'(บอก|tell).*หน่อย$',  # ต้องจบด้วย "หน่อย"
            r'^(ช่วย|help).*หน่อย$'  # ต้องจบด้วย "หน่อย"
        ]
